...
public class SimonOrderViewImpl extends CustomComponent implements SimonOrderView, ClickListener {
	/**
	 * 
	 */
	...
	public SimonOrderViewImpl(Navigator navigator) {
		...
		for (int i = 0; i < 5; i++) {
			...
			checkBoxList.add(new CheckBox(Integer.toString(i), false));
